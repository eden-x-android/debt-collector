...
type ExportPanelProps = {
  groups: GroupWithRecordsDto[] | undefined;
  exportPath: string;
};

/** Nút "Xuất báo cáo" + dialog chọn nhóm/định dạng. Dùng chung cho trang có auth và public. */
export function ExportPanel({ groups, exportPath }: ExportPanelProps) {
  const [open, setOpen] = useState(false);
  const exportReport = useExportReport(exportPath);
